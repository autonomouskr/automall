		...
		<div style="width:95%;margin:0 auto;">
			<div class="socialLogin_msg">
				...
				<div class="socialMsg_content">
					...
					<?php }else{?>
						현재 로그인 하신 <span class="socialLogin_ok">[ 카카오 ]</span>의 이메일 주소와 일치하는 회원정보가 존재합니다.<br />
			...
			<form method="post" name="login_frm" id="login_frm">
				...
				<?php
				/*
				echo "[Kakao Callback Result]<br /><br /><pre>";
				print_r($userInfo);
				echo "</pre>";
				*/
				?>
...
elseif($rtnFlag=='codeError'){ // 에러
	echo "<script>alert('카카오 아이디로 로그인에 실패하였습니다.');self.close();</script>";
}
?>
	</div>
</body>

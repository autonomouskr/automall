...
<input type=hidden name=rStoreId value="<?php echo $agspay->GetResult("rStoreId")?>">
<input type=hidden name=AuthTy value="<?php echo $agspay->GetResult("AuthTy")?>">
<input type=hidden name=SubTy value="<?php echo $agspay->GetResult("SubTy")?>">
<input type=hidden name=rApprNo value="<?php echo $agspay->GetResult("rApprNo")?>">
<input type=hidden name=rApprTm value="<?php echo $agspay->GetResult("rApprTm")?>">
<input type=hidden name=rBusiCd value="<?php echo $agspay->GetResult("rBusiCd")?>">
<input type=hidden name=rSuccYn value="<?php echo $agspay->GetResult("rCancelSuccYn")?>">
<input type=hidden name=rResMsg value="<?php echo $agspay->GetResult("rCancelResMsg")?>">
<input type=hidden name=rOrdNo value="<?php echo $agspay->GetResult("rOrdNo")?>">
<input type=hidden name=rInstmt value="<?php echo $agspay->GetResult("rInstmt")?>">
<input type=hidden name=rAmt value="<?php echo $agspay->GetResult("rAmt")?>">
<input type=hidden name=rCardNm value="<?php echo $agspay->GetResult("rCardNm")?>">
<input type=hidden name=rCardCd value="<?php echo $agspay->GetResult("rCardCd")?>">
<input type=hidden name=rMembNo value="<?php echo $agspay->GetResult("rMembNo")?>">
<input type=hidden name=rAquiCd value="<?php echo $agspay->GetResult("rAquiCd")?>">
<input type=hidden name=rAquiNm value="<?php echo $agspay->GetResult("rAquiNm")?>">
<input type=hidden name=rDealNo value="<?php echo $agspay->GetResult("rDealNo")?>">
</form>
</body>
</html>

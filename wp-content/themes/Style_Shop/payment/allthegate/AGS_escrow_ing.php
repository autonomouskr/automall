...
<input type=hidden name=rTrCode value="<?php echo $rTrCode?>">
<input type=hidden name=rPayKind value="<?php echo $rPayKind?>">
<input type=hidden name=rRetailerId value="<?php echo $rRetailerId?>">
<input type=hidden name=rSuccYn value="<?php echo $rSuccYn?>">
<input type=hidden name=rResMsg value="<?php echo $rResMsg?>">
</form>
</body>
</html>

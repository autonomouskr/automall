...
{
	if("<?php echo $rSuccYn?>"== "y" && "<?php echo $AuthTy?>"=="card")
	{
			...
			<tr>
				...
				<table width=400 border=0 cellpadding=0 cellspacing=0>
					...
					<tr>
						...
						<td class=clsleft><?php echo $rStoreId?></td>
					</tr>
					<tr>
						<td class=clsright>주문번호 : </td>
						<td class=clsleft><?php echo $rOrdNo?></td>
					</tr>
					<tr>
						<td class=clsright>주문자명 : </td>
						<td class=clsleft><?php echo $rOrdNm?></td>
					</tr>
					<tr>
						<td class=clsright>상품명 : </td>
						<td class=clsleft><?php echo $rProdNm?></td>
					</tr>
					<tr>
						<td class=clsright>결제금액 : </td>
						<td class=clsleft><?php echo $rAmt?></td>
					</tr>
					<tr>
						<td class=clsright>성공여부 : </td>
						<td class=clsleft><?php echo $rSuccYn?></td>
					</tr>
					<tr>
						<td class=clsright>처리메세지 : </td>
						<td class=clsleft><?php echo $rResMsg?></td>
					</tr>
<?php if($AuthTy == "card" || $AuthTy == "virtual") { ?>
					<tr>
						<td class=clsright>승인시각 : </td>
						<td class=clsleft><?php echo $rApprTm?></td>
					</tr>
<?php }
				if($AuthTy == "card" && $rSuccYn == "y") {?>
					<tr>
						<td class=clsright>전문코드 : </td>
						<td class=clsleft><?php echo $rBusiCd?></td>
					</tr>
					<tr>
						<td class=clsright>승인번호 : </td>
						<td class=clsleft><?php echo $rApprNo?></td>
					</tr>
					<tr>
						<td class=clsright>카드사코드 : </td>
						<td class=clsleft><?php echo $rCardCd?></td>
					</tr>
					<tr>
						<td class=clsright>거래번호 : </td>
						<td class=clsleft><?php echo $rDealNo?></td>
					</tr>
<?php }
				if($AuthTy == "card" && ($SubTy == "visa3d" || $SubTy == "normal") && $rSuccYn == "y") {?>
					<tr>
						<td class=clsright>카드사명 : </td>
						<td class=clsleft><?php echo $rCardNm?></td>
					</tr>
					<tr>
						<td class=clsright>매입사코드 : </td>
						<td class=clsleft><?php echo $rAquiCd?></td>
					</tr>
					<tr>
						<td class=clsright>매입사명 : </td>
						<td class=clsleft><?php echo $rAquiNm?></td>
					</tr>
					<tr>
						<td class=clsright>가맹점번호 : </td>
						<td class=clsleft><?php echo $rMembNo?></td>
					</tr>					
<?php }
				if($AuthTy == "iche" ) {?>
					<tr>
						<td class=clsright>이체계좌은행명 : </td>
						<td class=clsleft><?php echo $ICHE_OUTBANKNAME?><?php echo getCenter_cd($ICHE_OUTBANKNAME)?></td>
					</tr>
					<tr>
						<td class=clsright>이체금액 : </td>
						<td class=clsleft><?php echo $ICHE_AMOUNT?></td>
					</tr>
					<tr>
						<td class=clsright>이체계좌소유주 : </td>
						<td class=clsleft><?php echo $ICHE_OUTBANKMASTER?></td>
					</tr>
					<tr>
						<td class=clsright>이지스에스크로(SEND_NO) : </td>
						<td class=clsleft><?php echo $ES_SENDNO?></td>
					</tr>
<?php }
				if($AuthTy == "hp" ) {?>
					<tr>
						<td class=clsright>핸드폰결제TID : </td>
						<td class=clsleft><?php echo $rHP_TID?></td>
					</tr>
					<tr>
						<td class=clsright>핸드폰결제날짜 : </td>
						<td class=clsleft><?php echo $rHP_DATE?></td>
					</tr>
					<tr>
						<td class=clsright>핸드폰결제핸드폰번호 : </td>
						<td class=clsleft><?php echo $rHP_HANDPHONE?></td>
					</tr>
					<tr>
						<td class=clsright>핸드폰결제통신사명 : </td>
						<td class=clsleft><?php echo $rHP_COMPANY?></td>
					</tr>
<?php }
				if($AuthTy == "ars" ) {?>
					<tr>
					...
					<tr>
						...
						<td class=clsleft><?php echo $rARS_PHONE?></td>
					</tr>
					<tr>
...
<?php }
				if($AuthTy == "virtual" ) {?>
					<tr>
						...
						<td class=clsleft><?php echo $rVirNo?></td>
					</tr>
                    <tr><!-- 은행코드(20) : 우리은행 -->
						<td class=clsright>입금은행 : </td>
						<td class=clsleft><?php echo getCenter_cd($VIRTUAL_CENTERCD)?></td>
					</tr>
                    <tr>
					<!--올더게이트에 등록된 상점명으로 표기-------->
...
<?php }
				if($AuthTy == "card" ) {?>
					<tr>
						...
						<!--영수증출력을위해서보내주는값-------------------->
						<input type=hidden name=sRetailer_id value="<?php echo $rStoreId?>"><!--상점아이디-->
						<input type=hidden name=approve value="<?php echo $rApprNo?>"><!---승인번호-->
						<input type=hidden name=send_no value="<?php echo $rDealNo?>"><!--거래고유번호-->
						<input type=hidden name=appr_tm value="<?php echo $rApprTm?>"><!--승인시각-->
						<!--영수증출력을위해서보내주는값-------------------->
...
<?php }	?>
					<tr>
						<td colspan="2"><?php echo $errResMsg?></td>
					</tr>
					<tr>
						<td colspan="2">원본 해쉬 : <?php echo $AGS_HASHDATA?></td>
					</tr>
					<tr>
						<td colspan="2">결과 해쉬 :<?php echo $rAGS_HASHDATA?></td>
					</tr>
					<tr>
						<td colspan=2>&nbsp;</td>
					</tr>

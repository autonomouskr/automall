...
<form name="frmAGS_pay_ing" method="post" action="<?php echo $_POST['Column1']; ?>/proc/order.exec.php">
<!-- 각 결제 공통 사용 변수 -->
...
<input type="hidden" name="Column2" value="<?php echo $_POST['Column2']; ?>">
<input type="hidden" name="Column3" value="<?php echo $_POST['Column3']; ?>">

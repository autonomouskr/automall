...
class nusoap_xmlschema extends nusoap_base  {
	...
	*/
	...
	function __construct($schema='',$xml='',$namespaces=array()) { 
		$this->nusoap_xmlschema($schema='',$xml='',$namespaces=array());
	}
...
class soapval extends nusoap_base {
	...
	*/
	...
	function __construct($name='soapval',$type=false,$value=-1,$element_ns=false,$type_ns=false,$attributes=false) { 
		$this->soapval($name='soapval',$type=false,$value=-1,$element_ns=false,$type_ns=false,$attributes=false);
	}
...
class soap_transport_http extends nusoap_base {
	...
	*/
	...
	function __construct($url, $curl_options = NULL, $use_curl = false) { 
		$this->soap_transport_http($url, $curl_options = NULL, $use_curl = false);
	}
...
class wsdl extends nusoap_base {
	...
	function __construct($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=30,$curl_options=null,$use_curl=false) { 
		$this->wsdl($wsdl = '',$proxyhost=false,$proxyport=false,$proxyusername=false,$proxypassword=false,$timeout=0,$response_timeout=30,$curl_options=null,$use_curl=false);
	}
...
* $soapclient = new soapclient5( string path [ ,mixed wsdl] );
*
...
* @access   public
*/
class soapclient5 extends nusoap_base  {
	...
	*/
	...
	function __construct($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = '') { 
		$this->soapclient5($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = '');
	}

	function soapclient5($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30, $portName = ''){
		parent::nusoap_base();
	...
	*/
	...
	";
		...
		$evalStr = 'class nusoap_proxy_'.$r.' extends soapclient5 {
	'.$evalStr.'
}';
		return $evalStr;
	}
...
if (!extension_loaded('soap')) {
	 ...
	 */
	class soapclient extends soapclient5 {
	}
}
?>

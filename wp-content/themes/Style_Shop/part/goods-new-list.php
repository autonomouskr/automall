...
$recommend = $wpdb->get_var("select display_goods from bbse_commerce_display where display_type='new'");
...
?>
		<!-- 상품 목록 -->
		<br /><h2 class="page_title"><?php echo get_option($theme_shortname."_goodsplace_title_4");//신상품;?></h2>
		<div class="article">
...
<!--					<li<?php if($sort_page=="recommend"){?> class="active col4"<?php }else{?> class="col4"<?php }?>><button type="button" onclick="location.href='<?php echo $curURL?>&sort_page=recommend';"><span>신상품</span></button></li>

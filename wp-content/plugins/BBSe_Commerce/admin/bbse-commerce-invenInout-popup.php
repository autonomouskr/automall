...
<head>
	...
	<script language="javascript">
		...
		function select_goods(){
            ...
            parent.document.getElementById("idx").value = idx
...
<body>
	<div class="wrap">
		<div id="popup-goods-list">
			...
			$sql  = $wpdb->prepare("SELECT * FROM bbse_commerce_goods WHERE 1=1 ".$addQuery.$sOption." ORDER BY idx DESC LIMIT %d, %d", $prepareParm);

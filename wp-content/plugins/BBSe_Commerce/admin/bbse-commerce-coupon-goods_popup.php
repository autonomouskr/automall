	...
	<script language="javascript">
		...
		function select_goods(){
			...
			for(i=0;i<chked;i++){
				...
				str +="<tr>"
					+"			<td><img src=\""+tUrl+"\" alt=\"상품이미지\" /></td>"
					+"			<td>"+tName+"</td>"
					+"			<td>"
					+"				<input type='hidden' name='product_id[]' value='"+tId+"' />"
			...
			jQuery(parent.document).contents().find('.product_wrap tbody').append(str);
			parent.remove_popup();
		}
	...
	<div class="wrap">
		<div id="popup-goods-list">
			...
			<select name="depth_1_category" id="depth_1_category">
				...
				/* Query String */
				$add_args = array("page"=>$page, "per_page"=>$per_page, "depth_1_category"=>$depth_1_category, "goods_search_name"=>$goods_search_name,"pTarget"=>$pTarget,"tNo"=>$tNo,"chkList"=>$chkList,"TB_iframe"=>$TB_iframe);
				?>
			</select>

...
<body  marginwidth="10" marginheight="5" bgcolor="#fcfcfc" style="background-color:#fcfcfc;">
	...
	<td align="center">
		...
		<div style="position:relative;width:650px;background:#ffffff;border-bottom:3px solid #696969;">
			...
			<tr>
			<td style="position:relative;letter-spacing:1px;font-family:'나눔고딕',NanumGothic,'굴림',gulim,'돋움',dotum,sans-serif;font-size:28px;line-height:40px;font-weight:bold;color:#F03612;text-align:left;padding-left:15px;" height="140" valign="middle">

					<div align="left" style="float:left;text-display:table-cell;vertical-align:bottom;padding-top:15px;">
						고객님의 입금이 <span style="display:block;font-size:33px;color:#111111">정상적으로 처리되었습니다.</span>
					</div>

					<div align="right" style="float:right;display:table-cell;vertical-align:middle;color:#AAAAAA;font-family:wingdings;font-weight:normal;font-size:140px;width:140px;line-height:140px;z-index:1;">8</div>
	  ...
	  <th valign="top" height="50" style="background:#ffffff;" align="left">
		<strong style="color:#333333;letter-spacing:-1px;font-size:14px;">
			<em style="color:#3089ca;font-style:normal;">{성명}</em> 고객님, 안녕하세요?
		</strong>
	  </th>
	  </tr>
	  <tr>
	  <td style="color:rgb(85,85,85);line-height:20px;font-size:12px;" valign="top" align="left">
			...
			{성명}님 께서 주문하신 상품의 결제가 정상적으로 완료되었습니다.<br />
			자세한 주문내역은 마이페이지에서 확인하실 수 있습니다.

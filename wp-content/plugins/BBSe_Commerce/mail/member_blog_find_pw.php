		...
		<tr>
			<td align="center">
				<div style="position:relative;width:650px;background:#ffffff;border-bottom:3px solid #696969;">
					<table summary="회원안내메일테이블입니다." style="text-align:center;letter-spacing:-1px;font-size:11px;border-bottom:0px solid #707070" border="0" cellspacing="0" cellpadding="0" width="100%">
					<tbody>
						<tr>
						...
						<tr>
							<td style="position:relative;letter-spacing:1px;font-family:'나눔고딕',NanumGothic,'굴림',gulim,'돋움',dotum,sans-serif;font-size:28px;line-height:40px;font-weight:bold;color:#F03612;text-align:left;padding-left:20px;" height="140" valign="middle">
								<div align="left" style="float:left;text-display:table-cell;vertical-align:bottom;padding-top:15px;">
									임시비밀번호로 로그인 후 <span style="display:block;font-size:33px;color:#111111">비밀번호를 재설정하세요.</span>
								</div>
								<div align="right" style="float:right;display:table-cell;vertical-align:middle;color:#AAAAAA;font-family:webdings;font-weight:normal;font-size:140px;width:140px;line-height:140px;z-index:1;">i</div>
							</td>
						</tr>
					</tbody>
					</table>
				...
				<tbody>
					  ...
					  <tr>
						  <th valign="top" height="50" style="background:#ffffff;" align="left">
							<strong style="color:#333333;letter-spacing:-1px;font-size:14px;">
								<em style="color:#3089ca;font-style:normal;">{성명}</em> 고객님,  저희 {사이트이름} 비밀번호 재설정을 요청하셨습니다.
							</strong>
						  </th>
					  </tr>
					  <tr>
						  <td style="color:rgb(85,85,85);line-height:20px;font-size:12px;" valign="top" align="left">
								...
								{성명}님의 임시 비밀번호를 안내해 드립니다.<br />
								아래 임시비밀번호로 로그인 하신 후 안전한 개인정보보호를 위해 비밀번호를 반드시 변경해주시기 바랍니다.<br /><br />

								<strong style="display:block;font-size:15px;color:#111111">- 임시 비밀번호 : <span style="color:#ff0000;letter-spacing:2px;">{새비밀번호}</span></strong><br />

								보다 편리하고 유익한 사이트 운영을 위해 항상 노력하겠습니다.<br />감사합니다.
					  ...
					  <tr>
						  <td valign="top" align="center" height="60">
								<!-- 버튼 -->
								<a href="{마이페이지링크}" style="display:inline-block;background:#F03612;margin:0 3px;text-align:center;color:#fff;border:solid 1px #F03612;vertical-align:middle;padding:6px 17px;font-weight:bold;line-height:21px;font-family:'돋움',dotum,sans-serif;font-size:12px;text-decoration:none;">사이트 바로가기 &gt;</a>
								<!--// 버튼 -->
							</td>
					  </tr>
					  <tr>
				...
				<tbody>
				  <tr>
					...
					<tr>
						<td style="color:rgb(117, 118, 129);line-height:16px;letter-spacing:0;font-size:11px;" valign="top">
						본 메일은 발신 전용으로 회신되지 않습니다.<br /> 사이트 운영 정보 및 주요 공지사항은 수신동의 여부에 관계없이 발송됩니다.
						</td>
					</tr>
					<tr>
						...
						<strong style="color:rgb(161,161,161);font-family:Tahoma,sans-serif;font-size:9px;"> {사이트이름}.</strong>

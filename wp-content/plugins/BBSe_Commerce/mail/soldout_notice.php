...
<body  marginwidth="10" marginheight="5" bgcolor="#fcfcfc" style="background-color:#fcfcfc;">
	...
	<td align="center">
		...
		<div style="position:relative;width:650px;background:#ffffff;border-bottom:3px solid #696969;">
			...
			<tr>
			<td style="position:relative;letter-spacing:1px;font-family:'나눔고딕',NanumGothic,'굴림',gulim,'돋움',dotum,sans-serif;font-size:25px;line-height:40px;font-weight:bold;color:#F03612;text-align:left;padding-left:15px;" height="140" valign="middle">
					<div align="left" style="float:left;text-display:table-cell;vertical-align:bottom;padding-top:15px;">
						고객님께서 '입고알림'을 신청하신 <span style="display:block;font-size:33px;color:#111111">상품이 입고완료 되었습니다.</span>
					</div>
					<div align="right" style="float:right;display:table-cell;vertical-align:middle;color:#AAAAAA;font-family:wingdings;font-weight:normal;font-size:130px;width:140px;line-height:140px;z-index:1;">8</div>
			</td>
			</tr>
			</tbody>
			</table>
	  ...
	  <th valign="top" height="50" style="background:#ffffff;" align="left">
		<strong style="color:#333333;letter-spacing:-1px;font-size:14px;">
			<em style="color:#3089ca;font-style:normal;">{성명}</em> 고객님, {사이트이름}을 이용해 주셔서 감사합니다.
		</strong>
	  </th>
	  </tr>
	  <tr>
	  <td style="color:rgb(85,85,85);line-height:20px;font-size:12px;" valign="top" align="left">
			...
			{성명}님 께서 '품절상품 입고알림 서비스'를 신청하신 상품이 입고완료 되었습니다.
	  ...
	  <td valign="top" align="center" height="60">
			<!-- 버튼 -->
			<a href="{마이페이지링크}" style="display:inline-block;background:#F03612;margin:0 3px;text-align:center;color:#fff;border:solid 1px #F03612;vertical-align:middle;padding:6px 17px;font-weight:bold;line-height:21px;font-family:'돋움',dotum,sans-serif;font-size:12px;text-decoration:none;">마이페이지 바로가기 &gt;</a>
			<!--// 버튼 -->
		</td>
	  </tr>
	  <tr>
	  ...
	  <td style="line-height:0;font-size:0px;" height="20" valign="top"></td>
		...
		본 메일은 발신 전용으로 회신되지 않습니다.<br /> 결제정보 및 주요 공지사항은 수신동의 여부에 관계없이 발송됩니다.
		</td>
		</tr>
		<tr>

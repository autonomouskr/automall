...
<head>
	...
	<title>회원가입메일</title>
	<style>
		body,td{font-size:9pt;font-family:'돋움',dotum,Verdana,Tahoma,Geneva;}
		p{margin-top:2px;margin-bottom:2px;}
		img{border:0px;} 
		caption {font-size:0 !important;height:0 !important;font-size:0;} 
		a,a:link,a:visited,a:active{text-decoration:none;color:#424242;}
	...
	<tr>
		<td align="center">
			<div style="position:relative;width:650px;background:#ffffff;border-bottom:3px solid #696969;">
				<table summary="회원가입안내메일테이블입니다." style="text-align:center;letter-spacing:-1px;font-size:11px;border-bottom:0px solid #707070" border="0" cellspacing="0" cellpadding="0" width="100%">
					<tbody>
						<tr>

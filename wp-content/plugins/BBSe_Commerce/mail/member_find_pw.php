				...
				<tbody>
					  ...
					  <tr>
						  <td style="color:rgb(85,85,85);line-height:20px;font-size:12px;" valign="top" align="left">
								...
								회원님의 보다 편리하고 안전한 쇼핑을 위해 항상 노력하겠습니다.<br />감사합니다.
					  ...
					  <tr>
						  <td valign="top" align="center" height="60">
								<!-- 버튼 -->
								<a href="{마이페이지링크}" style="display:inline-block;background:#F03612;margin:0 3px;text-align:center;color:#fff;border:solid 1px #F03612;vertical-align:middle;padding:6px 17px;font-weight:bold;line-height:21px;font-family:'돋움',dotum,sans-serif;font-size:12px;text-decoration:none;">쇼핑몰 바로가기 &gt;</a>
								<!--// 버튼 -->
							</td>
					  </tr>
					  <tr>

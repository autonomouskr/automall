...
<body>
<form name="pwd_frm" method="post" action="<?php echo BBSE_BOARD_PLUGIN_WEB_URL?>proc/pass_check.exec.php">
...
<div>
	<div class="pw_box">
		...
		<fieldset>
			...
			<p class="pw_btn_w"><a href="javascript:;" onclick="check();"><input title="확인" class="pw_box_btn" type="button" value="확인" /></a><a href="javascript:;" onclick="location.href='<?php echo BBSE_BOARD_SITE_URL?>?page_id=<?php echo $_GET['page_id']?>&nType=<?php echo bbse_board_parameter_encryption($V['bname'], "list", "", $V['page'], $V['keyfield'], $V['keyword'], $V['search_chk'], $V['cate'])?>';"><input title="취소" class="pw_box_btn" type="button" value="취소" /></a></p>
		</fieldset>
	</div>
</div>
</form>

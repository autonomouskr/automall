...
<div id="bbse_board" style="width:<?php echo $table_width?>;<?php echo $table_align?>">
	...
	<tr>
		<td class="cont" colspan="2">
			<?php if(!empty($view_file_result1)) echo $view_file_result1?><?php if(!empty($view_file_result2)) echo $view_file_result2?><?php if(!empty($content)) echo stripslashes($content)?>
	...
	<div class="bbse_board_foot">
		...
		<div class="btn">
			<?php echo $view_reply?><span>답글</span></a>

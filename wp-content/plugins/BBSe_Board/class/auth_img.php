...
imagettftext($img, rand(20, 40), rand(0, 10),  5, rand(40, 50), $clr_frgrnd1, './arial.ttf', substr($_SESSION['authKey'], 0, 1));
imagettftext($img, rand(20, 40), rand(0, 10), 30, rand(40, 50), $clr_frgrnd2, './arial.ttf', substr($_SESSION['authKey'], 1, 1));
imagettftext($img, rand(20, 40), rand(0, 10), 55, rand(40, 50), $clr_frgrnd3, './arial.ttf', substr($_SESSION['authKey'], 2, 1));
imagettftext($img, rand(20, 40), rand(0, 10), 80, rand(40, 50), $clr_frgrnd4, './arial.ttf', substr($_SESSION['authKey'], 3, 1));
